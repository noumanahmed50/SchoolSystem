<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2 col-xl-2 col-xxl-2 border-rt-e6 px-0">
    <div class="d-flex flex-column align-items-center align-items-sm-start ">
                <ul class="nav flex-column pt-2 w-100">
                    ...
                    @endif --}}
                    <li class="nav-item border-bottom">
                        <a type="button" href="{{route('payments.create')}}" class="d-flex nav-link {{ request()->is('marks*')? 'active' : '' }} dropdown-toggle caret-off" data-bs-toggle="dropdown" aria-expanded="false"><i class="bi bi-currency-exchange"></i><span class="ms-1 d-inline d-sm-none d-md-none d-xl-inline">Payment</span>
                            <i class="ms-auto d-inline d-sm-none d-md-none d-xl-inline bi bi-chevron-down"></i>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="{{route('payments.create')}}">Create payment</a></li>
                            <li><a class="dropdown-item" href="{{route('payments.manage')}}">View Payable</a></li>
                        </ul>
                    </li>
