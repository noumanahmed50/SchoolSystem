                        ...
                        <form class="row g-3" action="{{route('school.student.create')}}" method="POST">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-3-md">
                                    ...
                                    <input type="text" class="form-control" id="inputAddress" name="address"  required value="{{old('address')}}">
                                </div>
                                <div class="col-3-md">
                                    <label for="inputAddress2" class="form-label">Address 2</label>
                                    <input type="text" class="form-control" id="inputAddress2" name="address2"  value="{{old('address2')}}">
                                </div>
                                <div class="col-md-3">
