                ...
                <div class="col ps-4">
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-start">
                                        <div class="ms-2 me-auto">
                                            <div class="fw-bold"><i class="bi bi-person-lines-fill"></i> Total Students</div>
                                        </div>
                    ...
                    <div class="mt-3 d-flex align-items-center">
                        <div class="col-3"style="width: 21%;">
                            ...
                            <span class="badge bg-dark rounded-pill border" >Male</span>
                            <span class="badge  bg-dark rounded-pill border">Female</span>
                        </div>
                        @php
                        ...
                        $femaleStudentPercentageStyle = "style='background-color: #26415c; width: $femaleStudentPercentage%'";
                        @endphp
                    ...
                    <div class="row align-items-md-stretch mt-4">
                        <div class="col">
                            <div class="p-3 text-white rounded-3" style="background-color: rgb(7, 27, 68)">
                                <h3>Welcome to UniQue School System!</h3>
