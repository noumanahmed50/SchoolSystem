...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('index', [PaymentController::class, 'index'])->name('payments.manage');
    Route::get('create', [PaymentController::class, 'create'])->name('payments.create');
    Route::post('store', [PaymentController::class, 'store'])->name('payments.store');
    Route::post('edit/{id}', [PaymentController::class, 'edit'])->name('payments.edit');
    Route::get('destroy/{id}', [PaymentController::class, 'destroy'])->name('payments.destroy');
